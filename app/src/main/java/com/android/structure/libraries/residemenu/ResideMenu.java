package com.android.structure.libraries.residemenu;
...
public class ResideMenu extends FrameLayout {
  ...
  /*  private LinearLayout layoutLeftMenu;
    ...
    public ResideMenu(HomeActivity homeActivity) {
        super(homeActivity);
        initViews(homeActivity, -1, -1);

        this.homeActivity = homeActivity;

        //blurTask = new BlurTask(homeActivity, i, R.id.container).execute();
     ...
     */
    public ResideMenu(Context homeActivity, int customLeftMenuId,
                      int customRightMenuId) {
        super(homeActivity);
        initViews(homeActivity, customLeftMenuId, customRightMenuId);
    }
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        rightMenuView = findViewById(R.id.rightMenuView);
     ...
     * @param activity
     */
    public void attachToActivity(HomeActivity activity) {
        initValue(activity);
        setShadowAdjustScaleXByOrientation();
        viewDecor.addView(this, 0);
    }

    private void initValue(HomeActivity activity) {
        try {
...
//            AnimatorSet scaleDown_activity = buildScaleDownAnimation(viewActivity, mScaleValue, 0.84f);
            ...
            homeActivity.setBlurBackground();

        } catch (Exception e) {
            e.printStackTrace();
        }

        //Blurry.with(homeActivity).radius(13).sampling(2).onto((ViewGroup) viewActivity );

        /*Blurry.with(homeActivity)
                .radius(10)
                .sampling(2)
                .async()
                .onto(homeActivity.getMainContentFrame());*/
    }
    ...
    private Animator.AnimatorListener animationListener = new Animator.AnimatorListener() {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (isOpened()) {
                ...
                //Blurry.delete(homeActivity.getMainContentFrame());
