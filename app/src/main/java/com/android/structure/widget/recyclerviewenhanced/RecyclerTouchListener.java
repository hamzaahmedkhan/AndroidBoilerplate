package com.android.structure.widget.recyclerviewenhanced;
...
//                Log.d("isRViewScrolling" , ""+isRViewScrolling);
            }
...
//                    onSwipeListener.onSwipeOptionsClosed();
    ...
    private void animateFG(View downView, Animation animateType, long duration) {
        if (animateType == Animation.OPEN) {
            ...
            onSwipeListener.onSwipeOptionsOpened(touchedPosition);
            ...
            onSwipeListener.onSwipeOptionsClosed(touchedPosition);
        }
    }
...
//                        }
    ...
    OnSwipeListenerPosition onSwipeListener;

    public void setSwipeListener(OnSwipeListenerPosition onSwipeListener) {
        this.onSwipeListener = onSwipeListener;
    }

    public boolean isRViewScrolling() {
        return isRViewScrolling;
    }
    ...
    public interface OnSwipeListenerPosition {
        void onSwipeOptionsClosed(int pos);

        void onSwipeOptionsOpened(int pos);
    }
}
